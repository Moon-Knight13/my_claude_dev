...
SRC_STACK="$_HERE/lib/guard-stack.sh"
...
# The composed stack the hook calls; without it the hook holds no opinion at all.
install -m 0644 "$SRC_STACK" "$LIB_DIR/guard-stack.sh"
...
host_info "stack   -> $LIB_DIR/guard-stack.sh"
host_info "hook    -> $HOOK"
